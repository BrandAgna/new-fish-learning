    ...
    for d in range(cl.filters[0].weights_grad.shape[0]):
        for i in range(cl.filters[0].weights_grad.shape[1]):
            for j in range(cl.filters[0].weights_grad.shape[2]):
                old_val = cl.filters[0].weights[d, i, j]
                cl.filters[0].weights[d, i, j] = old_val + epsilon
                cl.forward(a)
                ...
                cl.filters[0].weights[d, i, j] = old_val
...
def test_pool():
    ...
    mpl.forward(a)
    print('input array:\n{}\noutput array:\n{}'.format(a, mpl.output_array))

def test_pool_bp():
    a, b, mpl = init_pool_test()
    mpl.backward(a, b)
    print('input array:\n{}\nsensitivity array:\n{}\ndelta array:\n{}'.format(a, b, mpl.delta_array))
