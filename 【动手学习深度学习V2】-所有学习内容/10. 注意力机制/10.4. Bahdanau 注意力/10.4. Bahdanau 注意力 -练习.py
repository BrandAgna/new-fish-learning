...
class Seq2SeqAttentionDecoder(AttentionDecoder):
    ...
    def init_state(self, enc_outputs, enc_valid_lens, *args):
        ...
        # LSTM的状态是一个元组(hidden_state, cell_state)
    ...
    def forward(self, X, state):
        ...
        for x in X:
            ...
            # LSTM的输出是(out, (hidden_state, cell_state))
...
class Seq2SeqAttentionDecoder(AttentionDecoder):
    ...
    @property
    def attention_weights(self):
        return torch.cat([step for step in self._attention_weights], dim=0)
